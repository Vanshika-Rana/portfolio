...
const SocialPost = ({ platform, url }: { platform: string; url: string }) => {
	...
	} else if (platform === "linkedin-video") {
		return (
			<div className='bg-zinc-900 rounded-xl p-6 border border-zinc-800 hover:border-blue-300 transition-all overflow-hidden'>
...
export default function Community() {
	...
	return (
		<main
			className='text-white max-w-6xl mx-auto px-4 py-8 
    h-screen'>
			<Script
